...
def emo_detector():
    ...
    using emotion_detector() function. The output returned shows a dictionary with 
    all the emotions, their scores and the dominant emotion.
    '''
    ...
    for emo_key in dict_response.keys()
        emo_value = dict_response[emo_key]
        str_aux = emo_key + "': " + dict_response[emo_key] 
